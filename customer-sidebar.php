<div class="card">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item <?php if($cur_page == 'customer-wishlist.php') {echo 'active';} ?>">
                                <a href="<?php echo BASE_URL; ?>customer-wishlist.php">Wishlist</a>
                            </li>
                            <li class="list-group-item <?php if($cur_page == 'customer-messages.php') {echo 'active';} ?>">
                                <a href="<?php echo BASE_URL; ?>customer-messages.php">Message</a>
                            </li>
