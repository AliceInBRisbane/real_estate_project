...
if(isset($_POST['form-submit'])){
    ...
    try{
        ...
        $statement = $pdo->prepare("UPDATE packages SET name=?, price=?, allowed_days=?, allowed_properties=?, allowed_featured_properties=?, allowed_photos=?, allowed_videos=? WHERE id=?");
        $statement->execute(array($_POST['name'],$_POST['price'],$_POST['allowed_days'],$_POST['allowed_properties'],$_POST['allowed_featured_properties'],$_POST['allowed_photos'],$_POST['allowed_videos'],$_REQUEST['id']));
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                <label>Name *</label>
                                <input type="text" class="form-control" autocomplete="off" name="name" value="<?php echo $result[0]['name']; ?>">
                            </div>
                            <div class="form-group mb-3">
                                <label>Price *</label>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control " name="allowed_photos" autocomplete="off" value="<?php echo $result[0]['allowed_photos'];?>">
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary" name="form-submit">Update</button>
                            </div>
                            </form>
                        </div>
                    </div>
