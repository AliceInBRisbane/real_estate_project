    ...
    <ul class="navbar-nav navbar-right justify-content-end rightsidetop">
        ...
        <li class="nav-item dropdown">
            ...
            <?php if($_SESSION['admin']['photo'] == ''): ?>
                <img src="<?php echo BASE_URL; ?>uploads/default.png" alt="" class="rounded-circle-custom">

            <?php else: ?>
                <img src="<?php echo BASE_URL; ?>uploads/<?php echo $_SESSION['admin']['photo']; ?>" alt="" class="rounded-circle-custom">
