...
$sessionTimeout = 1200; // 200 minutes
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL; ?><?php echo BASE_URL; ?>dist/css/magnific-popup.css">
                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo BASE_URL;?>locations/1" class="nav-link">Locations</a>
                            </li>
                            <li class="nav-item">
