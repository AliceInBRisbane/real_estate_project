...
<?php
$statement = $pdo->prepare("SELECT agent_id FROM orders WHERE expire_date >= CURDATE() AND currently_active= ?");
$statement->execute([1]);
...
<div class="page-top" style="background-image: url('uploads/banner.jpg')">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2>Agent Detail of <?php echo $result[0]['full_name'];?></h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="property">
        <div class="container">
            <div class="row">
                <?php 
                $statement = $pdo->prepare("SELECT p.*,t.name as type_name,l.name as location_name,a.full_name as full_name,a.company as agent_company,a.photo as agent_photo 
                                            FROM properties p
                                            JOIN agents a
                                            ON p.agent_id = a.id
                                            JOIN locations l
                ...
                foreach ($result as $row) {
                    ...
                    <div class="item">
                        <div class="photo">
                            ...
                            <div class="top">
                                <div class="status-<?php if($row['purpose']=='Sale'){echo 'sale';}else{echo 'rent';}?>">
