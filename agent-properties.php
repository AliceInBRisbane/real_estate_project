...
// Check if the agent has purchased a package
        ...
        <div class="container">
            <div class="row">
                ...
                <table class="table table-bordered" id="datatable">
                            ...
                            <tbody>
                                <?php
                                $statement = $pdo->prepare("SELECT properties.*, types.name as types_name, locations.name as locations_name, GROUP_CONCAT(amenities.name) as amenity_names
                                                                    FROM properties
                                                                    JOIN types
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>For<?php echo $row['purpose']; ?></td>
                                        <td>
