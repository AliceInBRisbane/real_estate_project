...
<div class="property">
    <div class="container">
        <div class="row">
            <?php
            $statement = $pdo->prepare("SELECT p.*,t.name as type_name,l.name as location_name,a.full_name as agent_fullname,a.company as agent_company,a.photo as agent_photo
                                        FROM properties p
                                        JOIN agents a
                                        ON p.agent_id = a.id
                                        JOIN locations l
                    ...
                    <div class="text">
                        ...
                        <div class="detail">
                            ...
                            <div class="agent-section">
                                ...
                                <a href=""><?php echo $row['agent_fullname'];?> (<?php echo $row['agent_company'];?>)</a>
                            </div>
                        </div>
                    </div>
                </div>
