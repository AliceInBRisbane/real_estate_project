...
if(isset($_POST['form_forget_password'])) {
    try {
        ...
        $email_message .= '<a href="'.BASE_URL.'customer-reset-password.php?email='.$_POST['email'].'&token='.$token.'">Customer Reset Password</a>';
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = 'Customer Reset Password';
                ...
                <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                    <div class="login-form">
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                <button type="submit" class="btn btn-primary bg-website" name="form_forget_password">
                                    Submit
                                </button>
                            </div>
                            <div class="mb-3">
