            ...
            <div class="col-lg-8 col-md-12">
                ...
                <div class="left-item">
                    ...
                    <div class="property related-property pt_0 pb_0">
                        ...
                        <?php
                        $statement=$pdo->prepare("SELECT p.*,l.name as location_name, t.name as type_name, a.full_name, a.photo as agent_photo ,a.company as agent_company
                            FROM properties p
                            JOIN locations l
                            ON p.location_id = l.id
                            JOIN types t
                        ...
                        $related_properties=$statement->fetchAll(PDO::FETCH_ASSOC);
                        $total_related_properties=$statement->rowCount();
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="detail">
                                            ...
                                            <div class="agent-section">
                                                ...
                                                <?php endif;  ?>
                                                <a href=""><?php echo $row['full_name']; ?>(<?php echo $row['agent_company'];?>)</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="right-item">
                    ...
                    <div class="table-responsive mt_25">
                        <table class="table table-bordered">
                            ...
                            <?php if($result[0]['facebook'] != '' || $result[0]['twitter'] != '' || $result[0]['linkedin'] != '' || $result[0]['youtube'] != '' || $result[0]['instagram'] != '' || $result[0]['pinterest'] != ''): ?>
                            <tr>
                                <td>Social: </td>
                                <td>
                                    <ul class="agent-ul">
                                        ...
                                        <li><a href="<?php echo $result[0]['linkedin'];?>"><i class="fab fa-linkedin"></i></a></li>
                                        <?php endif; ?>
                    ...
                    <div class="summary">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td><b>Status</b></td>
                                    <td>For <?php echo $result[0]['purpose']; ?></td>
                                </tr>
                                <tr>
                                    <td><b>Bedroom:</b></td>
                ...
                <div class="right-item">
                    ...
                    <div class="amenity">
                        <ul class="amenity-ul">
                            <?php 
                                $tem_arr=[];
                                $tem_arr=explode(',',$result[0]['amenities']);
